...
'''
MODE = 'train'
root = '/Volumes/Qing Xiao/ikg/3_image_generation/{}/'.format(MODE)
save_root = '/Volumes/Qing Xiao/ikg/3_image_generation/{}/composite_image/'.format(MODE)
save_root_ref = '/Volumes/Qing Xiao/ikg/3_image_generation/{}/reflectance_png/'.format(MODE) 
save_root_tmp = '/Volumes/Qing Xiao/ikg/3_image_generation/{}/density_tmp/'.format(MODE) 

if not os.path.exists(save_root):
    os.makedirs(save_root)  
if not os.path.exists(save_root_tmp):
    os.makedirs(save_root_tmp)  
...
reflectance_path_root = os.path.join(root, 'reflectance')
