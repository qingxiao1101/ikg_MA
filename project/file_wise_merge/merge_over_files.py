...
root = '/Volumes/Qing Xiao/ikg/6_tmp/'
save_root = os.path.join(root, 'geojson_splitover30m_total_overlap')
...
df, match = merge(os.path.join(root, 'intermediate_splitover30'))
