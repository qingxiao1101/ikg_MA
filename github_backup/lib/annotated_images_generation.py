...
import xlrd
import sys
sys.path.insert(0, '../2_facade_extraction/')
import geopandas
...
root = '/Volumes/Qing Xiao/ikg/6_tmp/tmp_dumpfiles_splitover30/'
geo_root = '/Volumes/Qing Xiao/ikg/6_tmp/geojson_splitover30_total_overlap/'
save_root_2d = '/Volumes/Qing Xiao/ikg/4_detection/part_dataset_v2/'
...
ids = read_excel_id(file)

for idx, nid in enumerate(ids):
    print('{} / {} ...'.format(idx, len(ids)-1))
    image_generation(nid)
